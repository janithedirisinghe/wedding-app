        ...
        <div className="card-elegant slide-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-sm text-pink-600 hover:text-pink-500 font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-neutral-600">
              ...
              <Link href="/register" className="font-medium text-pink-600 hover:text-pink-500 transition-colors duration-200">
                Sign up for free
              </Link>
            </p>
          </div>
